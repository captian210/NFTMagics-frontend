...
import { HeaderSection, TicketSection, CheckSection, FinishedRoundSection, HowPlaySection, Modal, Input } from './styles';

const LotterySection = () => {
    const theme = useTheme();
    const fullScreen = useMediaQuery(theme.breakpoints.down('md'));
    const [modal, setModal] = React.useState(false);
    const [ticketNumber, setTicketNumber] = React.useState(5263543);
    ...
    const handlePre = () => {
        setTicketNumber(Number(ticketNumber) - 1);
    }
    const handleNext = () => {
        setTicketNumber(Number(ticketNumber) + 1);
    }
                ...
                <div>
                    ...
                    <DialogContent className=''>
                        <div className="modal-body">
                            <Button className='left-arrow' onClick={handlePre}>
                                <div>
                                    <ArrowBackIcon />
                                </div>
                            </Button>
                            <div className='ticket-body'>
                                <div className='ticket'>
                                    <Image src={'/images/design/ticket-1.png'} layout={'fill'} objectFit={'fill'} />
                                </div>
                                <div className='ticket-number'>
                                    ...
                                    <div>
                                        <Input className="input-text">
                                            ...
                                            <input autoCapitalize="off" id="ticket-number" name="ticket-number" placeholder="Ticket Number" type="number" value={ticketNumber} onChange={handleChangeNumber}></input>
                                        </Input>
                                    </div>
                                </div>
                                <button autoFocus className='' onClick={handleBuyTicket}>
                                    Buy Ticket
                                </button>
                            </div>
