                    ...
                    '& .navbar-list-content': {
                        ...
                        '& .filter-panel': {
                            ...
                            '& .filter-panel-item': {
                                ...
                                transition: 'all 0.2s ease 0s',
                                '&:hover': {
                                    boxShadow: 'rgb(4 17 29 / 25%) 0px 0px 8px 4px',
                                    transition: 'all 0.2s ease 0s',
                                },
                                '&.isSelected': {
                                    color: 'white',
...
export const MarketplaceHeader = styled('div')(({ theme, readmore }: { theme?: any, readmore: any }) => {
    return ({
        position: 'relative',
        '& .marketplace-banner': {
            display: 'flex',
        ...
        '& .marketplace-info': {
            ...
            '& .collection-add': {
                ...
                '& .add': {
                    ...
                    justifyContent: 'center',
                    '&:hover': {
                        boxShadow: `0px 0px 8px 4px ${theme.palette.divider}`,
                        transition: 'all 0.2s ease 0s',
                    }
                }
            },
