export const selectMarketInfo = ( state:any ) => state.marketplace.marketInfo;
export const selectMarketplace = ( state:any ) => state.marketplace.marketplace;
export const selectMarketItem = ( state:any ) => state.marketplace.currentMarketItem;
